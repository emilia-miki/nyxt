...
(defmethod install ((renderer electron-renderer))
  ;; Could be part of initialize-instance of electron-renderer, but that
  ;; wouldn't be symmetric wrt electron::terminate.
  ;; (electron::launch)
...
(defmethod ffi-kill-browser ((browser electron-browser))
  ...
  ;; not accurate... this only kills the socket
  (electron::terminate))
...
(defmethod ffi-window-make ((browser electron-browser))
  (make-instance 'electron::browser-window))
